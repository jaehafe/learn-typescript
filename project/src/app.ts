...
// HTMLParagraphElement: <p> 요소를 다루는 인터페이스
const confirmedTotal = $('.confirmed-total') as HTMLSpanElement;
const deathsTotal = $('.deaths') as HTMLParagraphElement; // assertion
...
//   { name: 'thor', age: 1000 },
// ];
// // 두 번째 인자(currentItem)는 각각의 요소를 의미
...
function setTotalDeathsByWorld(data: any) {
  deathsTotal.innerText = data.Countries.reduce(
    (total: any, current: Country) => (total += current.TotalDeaths),
    0
  );
}
